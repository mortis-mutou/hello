...
export default function Layout() {
    ...
    return (
        <AntLayout style={{ minHeight: '100vh', background: isDark ? '#0f0f1a' : '#fff0f5' }}>
            <Header style={headerStyle}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexShrink: 0 }}>
                    ...
                    <Button
                        type="text"
                        icon={isDark ? <SunOutlined style={{ color: '#ffd700', fontSize: 20 }} /> : <MoonOutlined style={{ color: 'white', fontSize: 20 }} />}
                        onClick={toggleTheme}
                        style={{
                            width: 40,
                            height: 40,
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                            background: isDark ? 'rgba(255,215,0,0.15)' : 'rgba(255,255,255,0.15)',
                            border: 'none',
                            cursor: 'pointer',
            ...
            <Content style={{ padding: '24px', minHeight: 'calc(100vh - 134px)', position: 'relative' }}>
                <div className="fade-in">
                    <Outlet />
                        ...
                        <Footer style={{
                textAlign: 'center',
                background: isDark ? 'linear-gradient(135deg, #1a1a2e, #16213e)' : 'linear-gradient(135deg, #fff0f5, #ffe4ec)',
                borderTop: isDark ? '1px solid #3a2a4a' : '1px solid #ffe4ec',
                color: isDark ? '#b0a0b0' : '#8c6b7a',
                fontSize: 14,
            }}>
