...
import { Card, Typography, Avatar, Button, Input, List, Space, message, Popconfirm, Empty, Spin, Divider } from 'antd';
import { ArrowLeftOutlined, HeartOutlined, HeartFilled, MessageOutlined, DeleteOutlined, EyeOutlined } from '@ant-design/icons';
            ...
            <Card title={`全部回复 (${replyTotal})`}>
                <List
                    ...
                    renderItem={(reply) => (
                        ...
                        >
                            <List.Item.Meta
                                avatar={<Avatar src={reply.avatar_url} />}
                                title={
                                    <Space>
